    ...
    <div className="min-h-screen flex" style={{ background: "var(--df-bg)" }}>
          ...
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {active && (
                  <ChevronRight size={14} className="text-sky-500 opacity-60" />
                )}
              </button>
            );
          })}
        ...
        >
          {data ? (
            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl px-4 py-3">
              ...
              <p className="text-xs truncate" style={{ color: "var(--df-t2)" }}>
                {data.filename}
              </p>
              <p
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px]" style={{ color: "var(--df-t3)" }}>
                  Upload to begin
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div
              ...
              style={{
                background: isDark ? "rgba(14,165,233,0.25)" : "#bae6fd",
              }}
            >
              <div
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-8">
          {activeTab === "convert" && (
            <ImportConvertView
              onDataLoaded={handleUploadSuccess}
          ...
          {activeTab === "eda" && data && (
            <EDAView data={data.eda} onDataUpdated={setData} />
          )}
          {activeTab === "insights" && data && (
            <InsightsView onNavigate={setActiveTab} />
          )}
